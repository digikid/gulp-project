...
│   │   ├── args.js                 # Преобразование консольных команд в настройки
│   │   ├── date.js                 # Форматирование текущей даты
...
now  | Дата и время, используется при формировании страницы со списком файлов проекта.
files  | Названия для файлов проекта
common  |  Настройки для списка страниц проекта
paths  |  Пути до файлов проекта
webserver  |  Параметры `browsersync`
