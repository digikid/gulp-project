...
- Компиляция JS файлов в стандарт ES5 с использованием [Babel](https://babeljs.io/) (опционально).
...
Для запуска проекта необходимо наличие установленного в системе [Node.js](https://nodejs.org/). Если необходимо, установите его с [официального сайта](https://nodejs.org/).
...
Для параметров с типом `Object` значения передаются через символ запятой `,` одной строкой: (пример: `--merge css,js`).
